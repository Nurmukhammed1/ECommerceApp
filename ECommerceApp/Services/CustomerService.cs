...
public class CustomerService
{
    ...
    public async Task<ApiResponse<CustomerResponseDTO>> RegisterAsync(CustomerRegistrationDTO customerDto)
    {
        try
        {
    ...
    public async Task<ApiResponse<ConfirmationResponseDTO>> UpdateCustomerAsync(CustomerUpdateDTO customerDto)
    {
        try
        {
            ...
            if (customer.Email.ToLower() != customerDto.Email.ToLower()
                && await _context.Customers.AnyAsync(c => c.Email.ToLower() == customerDto.Email.ToLower()))
